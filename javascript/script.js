...
function updateTimer() {
  const targetDate = new Date("March 22, 2025 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543865316283'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543865581602'; // Número para el primer botón
  const recipientNumber2 = '543865316283'; // Número para el segundo botón
